...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/modelsim/modelsim.ini -wlf {C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.signed_Q8.3_Q8.3.T1_fd50526d56f79a3e82192b8d651095f593f492a5/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/divider_tb/data_type_g=signed -g/divider_tb/dividend_width_g=8 -g/divider_tb/dividend_int_bits_g=3 -g/divider_tb/divisor_width_g=8 -g/divider_tb/divisor_int_bits_g=3 -g/divider_tb/runner_cfg={"active python runner : true,enabled_test_cases : T1,output path : C::/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.signed_Q8.3_Q8.3.T1_fd50526d56f79a3e82192b8d651095f593f492a5/,tb path : C::/Projekty/VHDL/Overwatch/src/ip_divider/hdl_tb/,use_color : true"} divider_tb_lib.divider_tb(beh)  -t ns -L vunit_lib -L osvvm -L common_tb_lib -L common_lib -L divider_lib -L divider_tb_lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/modelsim/modelsim.ini -wlf {C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.signed_Q8.3_Q8.3.T1_fd50526d56f79a3e82192b8d651095f593f492a5/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/divider_tb/data_type_g=signed -g/divider_tb/dividend_width_g=8 -g/divider_tb/dividend_int_bits_g=3 -g/divider_tb/divisor_width_g=8 -g/divider_tb/divisor_int_bits_g=3 -g/divider_tb/runner_cfg={"active python runner : true,enabled_test_cases : T1,output path : C::/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.signed_Q8.3_Q8.3.T1_fd50526d56f79a3e82192b8d651095f593f492a5/,tb path : C::/Projekty/VHDL/Overwatch/src/ip_divider/hdl_tb/,use_color : true"} divider_tb_lib.divider_tb(beh)  -t ns -L vunit_lib -L osvvm -L common_tb_lib -L common_lib -L divider_lib -L divider_tb_lib' failed
...
proc is_test_suite_done {} {
    set fd [open "C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.signed_Q8.3_Q8.3.T1_fd50526d56f79a3e82192b8d651095f593f492a5/vunit_results" "r"]
