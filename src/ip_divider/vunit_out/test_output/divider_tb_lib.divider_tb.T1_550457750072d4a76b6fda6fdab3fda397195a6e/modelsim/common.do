...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/modelsim/modelsim.ini -wlf {C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.T1_550457750072d4a76b6fda6fdab3fda397195a6e/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/divider_tb/runner_cfg={"active python runner : true,enabled_test_cases : T1,output path : C::/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.T1_550457750072d4a76b6fda6fdab3fda397195a6e/,tb path : C::/Projekty/VHDL/Overwatch/src/ip_divider/hdl_tb/,use_color : true"} divider_tb_lib.divider_tb(beh)  -t ns -L vunit_lib -L osvvm -L common_tb_lib -L common_lib -L divider_lib -L divider_tb_lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/modelsim/modelsim.ini -wlf {C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.T1_550457750072d4a76b6fda6fdab3fda397195a6e/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/divider_tb/runner_cfg={"active python runner : true,enabled_test_cases : T1,output path : C::/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.T1_550457750072d4a76b6fda6fdab3fda397195a6e/,tb path : C::/Projekty/VHDL/Overwatch/src/ip_divider/hdl_tb/,use_color : true"} divider_tb_lib.divider_tb(beh)  -t ns -L vunit_lib -L osvvm -L common_tb_lib -L common_lib -L divider_lib -L divider_tb_lib' failed
...
proc is_test_suite_done {} {
    set fd [open "C:/Projekty/VHDL/Overwatch/src/ip_divider/vunit_out/test_output/divider_tb_lib.divider_tb.T1_550457750072d4a76b6fda6fdab3fda397195a6e/vunit_results" "r"]
